...
const Swiper = (0, import_index_12277b03.c)(($$result, $$props, $$bindings, slots) => {
  let $$restProps = (0, import_index_12277b03.a)($$props, ["class", "swiper"]);
  const dispatch = (0, import_index_12277b03.b)();
  ...
  const setVirtualData = (data) => {
    virtualData = data;
    (0, import_index_12277b03.t)().then(() => {
  ...
  return `<div${(0, import_index_12277b03.d)([
    {
      class: (0, import_index_12277b03.f)(uniqueClasses(`${containerClasses}${className ? ` ${className}` : ""}`))
    },
    (0, import_index_12277b03.g)(restProps)
  ], {})}${(0, import_index_12277b03.h)("this", swiperEl, 0)}>${slots["container-start"] ? slots["container-start"]({ virtualData }) : ``}
  ${needsNavigation(swiperParams) ? `<div class="${"swiper-button-prev"}"${(0, import_index_12277b03.h)("this", prevEl, 0)}></div>
    <div class="${"swiper-button-next"}"${(0, import_index_12277b03.h)("this", nextEl, 0)}></div>` : ``}
  ${needsScrollbar(swiperParams) ? `<div class="${"swiper-scrollbar"}"${(0, import_index_12277b03.h)("this", scrollbarEl, 0)}></div>` : ``}
  ${needsPagination(swiperParams) ? `<div class="${"swiper-pagination"}"${(0, import_index_12277b03.h)("this", paginationEl, 0)}></div>` : ``}
...
const Swiper_slide = (0, import_index_12277b03.c)(($$result, $$props, $$bindings, slots) => {
  let slideData;
  let $$restProps = (0, import_index_12277b03.a)($$props, ["zoom", "virtualIndex", "class"]);
  ...
  return `<div${(0, import_index_12277b03.d)([
    {
      class: (0, import_index_12277b03.f)(uniqueClasses(`${slideClasses}${className ? ` ${className}` : ""}`))
    },
    {
      "data-swiper-slide-index": (0, import_index_12277b03.f)(virtualIndex)
    },
    (0, import_index_12277b03.g)($$restProps)
  ], {})}${(0, import_index_12277b03.h)("this", slideEl, 0)}>${zoom ? `<div class="${"swiper-zoom-container"}"${(0, import_index_12277b03.h)("data-swiper-zoom", typeof zoom === "number" ? zoom : void 0, 0)}>${slots.default ? slots.default({ data: slideData }) : ``}</div>` : `${slots.default ? slots.default({ data: slideData }) : ``}`}</div>`;
});
var swiper_min = "";
var effectFade_min = "";
var navigation_min = "";
const Slider = (0, import_index_12277b03.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_12277b03.v)(Swiper, "Swiper").$$render($$result, {
    navigation: true,
    slidesPerView: 1,
    ...
    default: () => {
      return `${(0, import_index_12277b03.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img class="${"object-cover"}" alt="${"military"}" src="${"http://premiertechsales.com/wp-content/uploads/2015/12/pts-military-2-0x0.jpg"}">
		<div class="${"slide-content absolute bottom-0 left-0 p-4 bg-primary-800 text-gray-100"}"><h2 class="${"text-2xl mb-2"}">Military</h2>
			<p>A wide range of products supporting our troops from Communications to Defense.</p></div>`;
        }
      })}
	${(0, import_index_12277b03.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img alt="${"commercial"}" src="${"http://premiertechsales.com/wp-content/uploads/2015/12/pts-commercial-avionics-0x0.jpg"}">
		<div class="${"slide-content absolute bottom-0 left-0 p-4 bg-primary-800 text-gray-100"}"><h2 class="${"text-2xl mb-2"}">Commercial</h2>
			<p>Products ranging from reference designs in the consumer market, through commercial avionics.</p></div>`;
        }
      })}
	${(0, import_index_12277b03.v)(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `<img alt="${"space"}" src="${"http://premiertechsales.com/wp-content/uploads/2015/12/pts-space-0x0.jpg"}">
		<div class="${"slide-content absolute bottom-0 left-0 p-4 bg-primary-800 text-gray-100"}"><h2 class="${"text-2xl mb-2"}">Space</h2>
			<p>Premier works with OEM Design Engineers on a wide array of products supporting the Space Markets.</p></div>`;
        }
      })}`;
    }
  })}`;
});
const Routes = (0, import_index_12277b03.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_12277b03.v)(Slider, "Slider").$$render($$result, {}, {}, {})}
<h1 class="${"text-3xl mt-8 mb-4 inline-block"}">Premier Technical Sales
</h1>
<p>Premier Tech Sales is a complete solution to your Field Representative needs in the states of
	Arizona and New Mexico. We are focused on RF/Microwave and Digital products and take great pride
	in offering professional services, working with our customers to support both existing and
